# JIRO Agent Build Guide

This file is the source of truth for AI coding agents working in this repository. Read it before making implementation decisions. Treat the requirements below as product constraints, not as documentation to repeat to the user.

## 1. Mission

Build JIRO, an AI resume tailoring assistant. The application accepts a job description and a resume, analyzes the job requirements, and produces a tailored resume that is keyword-aligned and ATS-friendly without fabricating experience.
...
Resume and job-description data is sensitive. Agents must apply these rules:
...
## 13. Product Decisions Still Requiring Deliberate Choice
